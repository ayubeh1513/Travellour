...
top.title('Train Ticket Management')
...
Label(top, text='Train Ticket Management', bg="#0A6372", fg="bisque", font=('Arial', 18, "bold")).grid(row=0, column=0, columnspan=2, padx=80, pady=20)
...
def Book():
    ...
    Label(top1, text='Train Number', bg="#0A6372", fg="bisque", font=('Arial', 12, "bold")).grid(row=2, column=0, padx=10, pady=10, sticky='w')
...
def ViewHistory():
    ...
    headers = ['Customer Name', 'Train Number', 'Ticket ID', 'Date of Booking', 'From', 'To', 'Price (INR)']
